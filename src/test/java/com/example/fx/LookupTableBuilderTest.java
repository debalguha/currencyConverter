...
public class LookupTableBuilderTest {
    ...
    public void test_buildFXConversionTable() throws Exception{
        ...
        Map<Pair<String, String>, Converter> pairConverterMap = LookupTableBuilderV2.withRefDataSource(new FileDataSource(new File(filePath), Utils.lineToFXEntriesMapping())).buildFXConversionTable();
